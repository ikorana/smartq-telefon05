...
class AsansorDevice extends BaseDevice {
  ...
  AsansorDevice.fromMap(Map<String, dynamic> map) : super.fromMap(map) {
  ...
  void _showStatusDialog() {
    ...
    Get.dialog(
      AlertDialog(
        title: Text("${name ?? 'asansor'.tr} - ${'status'.tr}"),
        content: Obx(() => Column(
  ...
  void _showGroupsDialog() {
    ...
    Get.dialog(
      AlertDialog(
        title: Text("${name ?? 'asansor'.tr} - ${'groups'.tr}"),
  ...
  void _showScenariosDialog() {
    ...
    Get.dialog(
      AlertDialog(
        ...
        title: Text("${name ?? 'asansor'.tr} - ${'scenarios'.tr}", style: TextStyle(color: theme.colorScheme.onSurface, fontSize: 18, fontWeight: FontWeight.bold), textAlign: TextAlign.center),
      ...
      SizedBox(
          ...
          children: [
            Row(
              children: [
                ...
                Expanded(child: Obx(() => Text(name ?? 'asansor'.tr, style: TextStyle(color: theme.colorScheme.onSurface, fontSize: 18, fontWeight: FontWeight.bold)))),
              ],
            ),
            const SizedBox(height: 15),
            SizedBox(
        ...
        content: SingleChildScrollView(
          ...
          children: [
            ...
            Opacity(
              opacity: 0.5,
              child: Image.asset('assets/images/asansor.png', width: 60, height: 60),
            ),
            const SizedBox(height: 20),
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                _buildActionBtn(Icons.power_settings_new, 'ASANSÖRÜ ÇAĞIR', () => _sendOpenCommand(), color: Colors.blue, widthMultiplier: 2.5),
                ...
                child: SizedBox(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      _buildBottomIconWithLabel(Icons.list_alt, 'details'.tr, () => _showAsansorDetailsPopup(), scale: iconScale),
  ...
  Widget buildWidget() {
    return Obx(() {
      return DeviceCardBase(
        ...
        icon: Opacity(
          opacity: 0.5,
          child: Image.asset('assets/images/asansor.png', width: 70, height: 70),
        ),
      );
    });
  }
