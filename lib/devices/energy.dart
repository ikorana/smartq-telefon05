...
class EnergyDevice extends BaseDevice {
  ...
  EnergyDevice.fromMap(Map<String, dynamic> map) : super.fromMap(map) {
  ...
  void _showStatusDialog() {
    ...
    Get.dialog(
      AlertDialog(
        title: Text("${name ?? 'energy'.tr} - ${'status'.tr}"),
        content: Obx(() => Column(
  ...
  void _showGroupsDialog() {
    ...
    Get.dialog(
      AlertDialog(
        title: Text("${name ?? 'energy'.tr} - ${'groups'.tr}"),
                ...
                return Obx(() {
                  ...
                  return InkWell(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(borderRadius: BorderRadius.circular(8), color: isLoading ? theme.colorScheme.primary.withOpacity(0.05) : null),
                      child: Row(
                        children: [
  ...
  void _showScenariosDialog() {
    ...
    Get.dialog(
      AlertDialog(
        ...
        title: Text("${name ?? 'energy'.tr} - ${'scenarios'.tr}", style: TextStyle(color: theme.colorScheme.onSurface, fontSize: 18, fontWeight: FontWeight.bold), textAlign: TextAlign.center),
        contentPadding: const EdgeInsets.fromLTRB(15, 20, 15, 10),
        content: SizedBox(
          width: 350,
          child: Obx(() {
            if (userManager.activeScenes.isEmpty) return Center(child: Padding(padding: const EdgeInsets.all(20.0), child: Text('no_users_found'.tr, style: TextStyle(color: theme.colorScheme.onSurface.withOpacity(0.6)))));
            return GridView.builder(
              shrinkWrap: true,
              ...
              itemBuilder: (context, index) {
                ...
                return ElevatedButton(
                  style: ElevatedButton.styleFrom(backgroundColor: theme.colorScheme.surface, foregroundColor: theme.colorScheme.onSurface, elevation: 1, padding: const EdgeInsets.symmetric(horizontal: 4), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10), side: BorderSide(color: Colors.grey.withOpacity(0.5)))),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Obx(() {
                        ...
                        return Text("Deger: $val", style: TextStyle(fontSize: 9, color: theme.colorScheme.primary.withOpacity(0.7), fontWeight: FontWeight.normal));
                      }),
                    ],
                  ),
                );
    ...
    return Row(
      ...
      children: [
        ...
        Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            IconButton(icon: const Icon(Icons.refresh, size: 20), onPressed: onRefresh, visualDensity: VisualDensity.compact, color: Get.theme.colorScheme.primary.withOpacity(0.7)),
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(color: Get.theme.colorScheme.surface, borderRadius: BorderRadius.circular(10), border: Border.all(color: Get.theme.colorScheme.primary.withOpacity(0.3))),
      ...
      AlertDialog(
        ...
        title: Column(
          children: [
            Row(
              children: [
                Container(width: 32, height: 32, alignment: Alignment.center, decoration: BoxDecoration(color: theme.colorScheme.primary.withOpacity(0.1), shape: BoxShape.circle, border: Border.all(color: theme.colorScheme.primary.withOpacity(0.3))), child: Text(id.toString(), style: TextStyle(color: theme.colorScheme.primary, fontSize: 13, fontWeight: FontWeight.bold))),
                const SizedBox(width: 12),
                Expanded(child: Obx(() => Text(name ?? 'energy'.tr, style: TextStyle(color: theme.colorScheme.onSurface, fontSize: 18, fontWeight: FontWeight.bold)))),
              ],
            ),
            const SizedBox(height: 15),
            Row(
        ...
        content: Column(
          ...
          children: [
            ...
            Obx(() {
              ...
              return Icon(Icons.flash_on, size: 60, color: isOn ? theme.colorScheme.primary : theme.colorScheme.onSurface.withOpacity(0.2));
            }),
            const SizedBox(height: 20),
            Obx(() => Column(
              children: [
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    _buildBottomIconWithLabel(Icons.list_alt, 'details'.tr, () => _showEnergyDetailsPopup()),
  ...
  Widget buildWidget() {
    ...
    return Obx(() {
      ...
      return DeviceCardBase(
        ...
        icon: Icon(Icons.flash_on, color: isOn ? Colors.orangeAccent : theme.colorScheme.onSurface.withOpacity(0.2), size: 70),
      );
    });
  }
}
