...
class GarageDevice extends BaseDevice {
  ...
  GarageDevice.fromMap(Map<String, dynamic> map) : super.fromMap(map) {
  ...
  void _showStatusDialog() {
    ...
    Get.dialog(
      AlertDialog(
        title: Text("${name ?? 'garage'.tr} - ${'status'.tr}"),
        content: Obx(() => Column(
        ...
        actions: [
          ...
          TextButton(onPressed: () => Get.back(), child: Text("close".tr.toUpperCase(), style: TextStyle(color: Get.theme.colorScheme.primary))),
        ],
      ),
  ...
  void _showGroupsDialog() {
    ...
    Get.dialog(
      AlertDialog(
        title: Text("${name ?? 'garage'.tr} - ${'groups'.tr}"),
  ...
  void _showScenariosDialog() {
    ...
    Get.dialog(
      AlertDialog(
        ...
        title: Text("${name ?? 'garage'.tr} - ${'scenarios'.tr}", style: TextStyle(color: theme.colorScheme.onSurface, fontSize: 18, fontWeight: FontWeight.bold), textAlign: TextAlign.center),
          ...
          children: [
            Row(
              children: [
                ...
                Expanded(child: Obx(() => Text(name ?? 'garage'.tr, style: TextStyle(color: theme.colorScheme.onSurface, fontSize: 18, fontWeight: FontWeight.bold)))),
              ],
            ),
            const SizedBox(height: 15),
          ...
          children: [
            ...
            Obx(() {
              ...
              return Image.asset(
                ...
                width: 60,
                height: 60,
                color: Colors.orange.withValues(alpha: isOpen ? 1.0 : 0.2),
