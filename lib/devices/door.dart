...
class DoorDevice extends BaseDevice {
  ...
  DoorDevice.fromMap(Map<String, dynamic> map) : super.fromMap(map) {
  ...
  void _showStatusDialog() {
    ...
    Get.dialog(
      AlertDialog(
        title: Text("${name ?? 'door'.tr} - ${'status'.tr}"),
        content: Obx(() => Column(
  ...
  void _showGroupsDialog() {
    ...
    Get.dialog(
      AlertDialog(
        title: Text("${name ?? 'door'.tr} - ${'groups'.tr}"),
  ...
  void _showScenariosDialog() {
    ...
    Get.dialog(
      AlertDialog(
        ...
        title: Text("${name ?? 'door'.tr} - ${'scenarios'.tr}", style: TextStyle(color: theme.colorScheme.onSurface, fontSize: 18, fontWeight: FontWeight.bold), textAlign: TextAlign.center),
          ...
          children: [
            Row(
              children: [
                ...
                Expanded(child: Obx(() => Text(name ?? 'door'.tr, style: TextStyle(color: theme.colorScheme.onSurface, fontSize: 18, fontWeight: FontWeight.bold)))),
              ],
            ),
            const SizedBox(height: 15),
