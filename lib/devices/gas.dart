...
class GasDevice extends BaseDevice {
  ...
  GasDevice.fromMap(Map<String, dynamic> map) : super.fromMap(map) {
  ...
  void _showStatusDialog() {
    ...
    Get.dialog(
      AlertDialog(
        title: Text("${name ?? 'gas'.tr} - ${'status'.tr}"),
        content: Obx(() => Column(
  ...
  void _showScenariosDialog() {
    ...
    Get.dialog(
      AlertDialog(
        ...
        title: Text("${name ?? 'gas'.tr} - ${'scenarios'.tr}", style: TextStyle(color: theme.colorScheme.onSurface, fontSize: 18, fontWeight: FontWeight.bold), textAlign: TextAlign.center),
      ...
      AlertDialog(
          ...
          children: [
            Row(
              children: [
                ...
                Expanded(child: Obx(() => Text(name ?? 'gas'.tr, style: TextStyle(color: theme.colorScheme.onSurface, fontSize: 18, fontWeight: FontWeight.bold)))),
              ],
            ),
            const SizedBox(height: 15),
            Row(
        ...
        content: Column(
          ...
          children: [
            ...
            Opacity(
              opacity: 0.5,
              child: Image.asset('assets/images/gaz.png', width: 60, height: 60),
            ),
            const SizedBox(height: 20),
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                _buildActionBtn(Icons.power_settings_new, 'GAZI KES', () => _sendOpenCommand(), color: Colors.red, widthMultiplier: 2.5),
  ...
  Widget buildWidget() {
    return Obx(() {
      return DeviceCardBase(
        ...
        icon: Opacity(
          opacity: 0.5,
          child: Image.asset('assets/images/gaz.png', width: 70, height: 70),
        ),
      );
    });
  }
