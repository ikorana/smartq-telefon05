...
class WaterDevice extends BaseDevice {
  ...
  WaterDevice.fromMap(Map<String, dynamic> map) : super.fromMap(map) {
  ...
  void _showStatusDialog() {
    ...
    Get.dialog(
      AlertDialog(
        title: Text("${name ?? 'water'.tr} - ${'status'.tr}"),
        content: Obx(() => Column(
  ...
  void _showGroupsDialog() {
    ...
    Get.dialog(
      AlertDialog(
        title: Text("${name ?? 'water'.tr} - ${'groups'.tr}"),
  ...
  void _showScenariosDialog() {
    ...
    Get.dialog(
      AlertDialog(
        ...
        title: Text("${name ?? 'water'.tr} - ${'scenarios'.tr}", style: TextStyle(color: theme.colorScheme.onSurface, fontSize: 18, fontWeight: FontWeight.bold), textAlign: TextAlign.center),
          ...
          children: [
            Row(
              children: [
                ...
                Expanded(child: Obx(() => Text(name ?? 'water'.tr, style: TextStyle(color: theme.colorScheme.onSurface, fontSize: 18, fontWeight: FontWeight.bold)))),
              ],
            ),
            const SizedBox(height: 15),
            Row(
          ...
          children: [
            ...
            Obx(() {
              ...
              return Image.asset(
                ...
                width: 60,
                height: 60,
                color: Colors.orange.withValues(alpha: isOn ? 1.0 : 0.2),
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    _buildBottomIconWithLabel(Icons.list_alt, 'details'.tr, () => _showWaterDetailsPopup()),
